...
public class UserSearchPagingHelper implements ResponsePaging<List<UserEntry>> {
    ...
    @Override
    public Single<List<UserEntry>> search(String searchUrl, Map<String, String> queryMap) {
        ...
        return service.searchUsers(searchUrl, newHashMap)
                .flatMap(new Function<Response<ResponseBody>, SingleSource<? extends List<UserEntry>>>() {
                    @Override
                    public SingleSource<? extends List<UserEntry>> apply(Response<ResponseBody> responseBodyResponse) throws Exception {
    ...
    @Override
    public Single<List<UserEntry>> getNextPage() {
